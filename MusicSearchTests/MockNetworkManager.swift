...
final class MockNetworkManager {
    ...
    /// This convinience init is used for mocking for get Music (songs, artist and album) list Apis
    convenience init(type:MusicType) {
        ...
        switch type {
        case .album:
            self.init(false, withMockData:"{\"results\":{\"opensearch:Query\":{\"#text\":\"\",\"role\":\"request\",\"searchTerms\":\"Sonu%20nigam\",\"startPage\":\"1\"},\"opensearch:totalResults\":\"24735\",\"opensearch:startIndex\":\"0\",\"opensearch:itemsPerPage\":\"1\",\"albummatches\":{\"album\":[{\"name\":\"Sonu Nigam: Best Of Me\",\"artist\":\"Sonu Nigam\",\"url\":\"https://www.last.fm/music/Sonu+Nigam/Sonu+Nigam:+Best+Of+Me\",\"image\":[{\"#text\":\"\",\"size\":\"small\"},{\"#text\":\"\",\"size\":\"medium\"},{\"#text\":\"\",\"size\":\"large\"},{\"#text\":\"\",\"size\":\"extralarge\"}],\"streamable\":\"0\",\"mbid\":\"\"}]},\"@attr\":{\"for\":\"Sonu%20nigam\"}}}", mockResposne: HTTPURLResponse(url:URL.init(string:  "https://foo.com")!, statusCode: 200, httpVersion: nil, headerFields: nil)!)
